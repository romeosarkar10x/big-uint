#ifndef __ASM__DIV__U_LL_HPP
#define __ASM__DIV__U_LL_HPP
...
** size
*/
static void __asm__div__u_ll(const volatile u_ll* lhs, const u_ll rhs, const u_ll size, volatile u_ll* quot, volatile u_ll* rem)
{
  asm(
    "movq %[lhs], %%r8\n\t"   //  r8: lhs
    "movq %[rhs], %%r9\n\t"   //  r9: rhs
