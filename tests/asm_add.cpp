...
int main()
{
    ...
    {
        // Test 2:
        volatile u_ll a[] = {3, 0, 0, 1, 3, 1, 0}, b[] = {2, 0, 0, ULONG_LONG_MAX, ULONG_LONG_MAX, 12, 0},
                      size__b = sizeof(b) / sizeof(u_ll);
    ...
    {
        // Test 4:
        volatile u_ll a[] = {6512548990859393274, 1, 0}, b[] = {216110626640441270, 0, 0},
                      size__b = sizeof(b) / sizeof(u_ll);
