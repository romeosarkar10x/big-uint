...
*/
static void __asm__mul(
    const volatile u_ll* lhs, const volatile u_ll* rhs, const u_ll size__lhs, const u_ll size__rhs, volatile u_ll* tmp,
    volatile u_ll* ans
)
{
    // std::cout << "@__asm__mul: " << lhs << " " << rhs << " " << size__lhs << " " << size__rhs << " " << tmp << " " <<
    // ans << "\n";
    for (u_ll u = 0; u < size__rhs; u++) {
        ...
        */
        ...
        // std::cout << "before __asm__add\n__asm__mul: " << lhs << " " << rhs << " " << size__lhs << " " << size__rhs
        // << " " << tmp << " " << ans << "\n";
